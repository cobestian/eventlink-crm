          ...
          {messages.map(m => (
            <div key={m.id} style={{ display: 'flex', justifyContent: m.sender_id === profile.id ? 'flex-end' : 'flex-start' }}>
              <div style={{
                ...
                background: m.sender_id === profile.id ? 'linear-gradient(135deg, #FF6B6B, #F59E0B)' : 'white',
    ...
    <div className="app-shell">
      <div className="app-header">
        <div style={{ position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ opacity: 0.75, fontSize: 13 }}>Chat with event organizers</p>
        </div>
      </div>
        ...
        {conversations.length === 0 ? (
          <div className="card">
            <div className="empty-state">
              ...
              <p>Messages from organizers will appear here</p>
            </div>
          </div>
